...
class NotificationRemoteSource {
  ...
  Future<void> markRead(String id) async {
    await _dio.put('/vendor/notifications/$id/read');
  }

  Future<void> markAllRead() async {
    await _dio.put('/vendor/notifications/read-all');
  }

  Future<int> getUnreadCount() async {
    final response = await _dio.get('/vendor/notifications/unread-count');
